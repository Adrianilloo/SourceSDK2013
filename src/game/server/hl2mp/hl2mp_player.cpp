...
{
	// No need to lag compensate at all if we're not attacking in this command and we haven't attacked recently
	if ( !FBitSet(pCmd->buttons, IN_ATTACK | IN_ATTACK2) && (pCmd->command_number - m_iLastWeaponFireUsercmd > 5))
		return false;
